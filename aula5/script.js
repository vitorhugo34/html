...
function jogar(escolha){ 
     ...
     if(jogadorEscolha == 1 && computadorEscolha == 1) {  ganhador = 0;
    ...
    } else if (jogadorEscolha == 2 && computadorEscolha == 2){  ganhador = 0;
    ...
    } else if (jogadorEscolha == 3 && computadorEscolha == 3){  ganhador = 0;
    ...
    if(ganhador == 0){  document.getElementById('mensagem').innerHTML = 'Empate';
} else if(ganhador == 1) {  document.getElementById('mensagem').innerHTML = 'Jogador Ganhou';
  jogadorPontuacao++;
 } else if(ganhador == 2) {  document.getElementById('mensagem').innerHTML = 'Computador Ganhou'; 
 computadorPontuacao++;
 }document.getElementById('jogadorPontos').innerHTML = jogadorPontuacao;document.getElementById('computadorPontos').innerHTML = computadorPontuacao;
}